package org.dp.smartcampus.util;
...
public class JwtHelper { // token生成工具类
    ...
    private static long tokenExpiration = 24*60*60*1000; // 有效期是一天
    private static String tokenSignKey = "123456"; // 生成token的基础上打上一个标签，避免破解
